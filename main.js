...
function addTask() {
    ...
    if(content.style.display === 'none') {
        ...
        if(text.value != '') {
            ...
            alert('YOU DİD NOT ENTER ANYTHİNG..!!');
        }
    }
...
sort.addEventListener('click', () => {
    ...
    if(srt == 'increment') {
        srt = 'decrement';
        sort.style.background = 'url(../to-do-list/symbol/sort-up-black.png)';
        sort.addEventListener('mouseout', (event) => {
            event.target.style.background = 'url(../to-do-list/symbol/sort-up.png)';
        });
        sort.addEventListener('mouseover', (event) => {
            event.target.style.background = 'url(../to-do-list/symbol/sort-up-black.png)';
        });
